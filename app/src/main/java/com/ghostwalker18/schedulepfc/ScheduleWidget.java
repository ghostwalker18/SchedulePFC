   ...
   private static class ScheduleObserver
      ...
      public void onChanged(Lesson[] lessons) {
         ...
         for(Lesson lesson : lessons){
            ...
            lessonItem.setTextViewText(R.id.lessonNumber, lesson.getLessonNumber());
            lessonItem.setTextViewText(R.id.subjectName, lesson.getSubject());
            lessonItem.setTextViewText(R.id.teacherName, lesson.getTeacher());
            lessonItem.setTextViewText(R.id.roomNumber, lesson.getRoomNumber());
